...
const FlightSearchBox = () => {
  ...
  const handleSearch = async () => {
    if (
      ...
      const setflights = await axios.post(
        "https://fligthback.onrender.com/api/fligthSearch",
        {
  ...
  return (
    <div className="container searchbox mt-5 pt-5">
          ...
          <div className="row">
            <div className="col-md-12">
              <div className="form-group">
                ...
                {fromhide || !fromInput ? null : (
                  <ul className="unlist ">
                    {fromInput &&
                      from.slice(0, 5).map((airport) => (
                        <li
                          onClick={() => {
                            setFromInput(airport.name);
                            setFromAirportCode(airport.code);
                            setFromAirportCity(airport.city);
                          }}
                          key={airport.code}
                        >
            ...
            <div className="col-md-12">
              <div className="form-group">
                ...
                {tohide || !toInput ? null : (
                  <ul className="unlist ">
                    {toInput &&
                      to.slice(0, 5).map((airport) => (
                        <li
                          onClick={() => {
                            settoInput(airport.name);
                            setToAirportCode(airport.code);
                            setToAirportCity(airport.city);
                          }}
                          key={airport.code}
                        >
                          {`${airport.name} - ${airport.code}`}
      ...
      <div className="row">
        <div className="col-md-12">
          <div className="form-group">
            <label htmlFor="RnumTravelers" className="travelers">
              Passengers
            </label>
            <input
              type="number"
        ...
        <div className="col-md-12 ">
          <div className="form-group">
            <label htmlFor="OCabinclass" className="ocl">
              Class
            </label>
            <select
              type="text"
      ...
      <Link
        ...
        className="btn btn-primary m-4 px-5 searchbtn"
      >
        <span>Search</span>
        <i className="bx bxs-plane d-flex"></i>
      </Link>
      {error && (
        <p className="error text-danger">please fill all required fields </p>
      )}{" "}
    </div>
  );
};
