...
const PassengerTicket = () => {
  ...
  const updateUserBooking = async () => {
    try {
      ...
      const postBookingDetails = await axios.post(
        "https://fligthback.onrender.com/api/userBooking",
        {
          username: username,
          emailid: emailid,
  ...
  return (
    <div>
      <button
        className="btn btn-primary bx bx-download tdbtn  mt-1"
        onClick={downloadPDF}
      >
        {" "}
        Download Ticket{" "}
      ...
      {/* <button
        className="btn btn-primary bx bxs-plane mx-5 gobackbtn mt-1 "
        onClick={handleBack}
      >
        {" "}
        Search flight
      ...
      <div ref={ticketRef} className="container">
        <header>
          <div className="tickethead row p-5">
            <div className="ticket-logo col-3 ">
              {" "}
              <img src={myflight.logo_url} alt="" />
            </div>
        ...
        <main>
          <div className=" container para">
            <p className="p1">
              Your electronic ticket is stored in our Computer reservation
              system. This e-Ticket receipt is your record of your
              electronic ticket and forms part of your contract of carriage. You
              may need to show this receipt to enter the airport and/or to prove
              return or onward travel to customs and immigration officials.{" "}
            </p>

            <p className="p2">
              Your attention is drawn to the conditions of contract and other
              important notices set out in the attached document.
            </p>
            <p className="p3">
              Economy Class passengers should report to Emirates check-in desks
              3 hours prior to departure of all flights. First and Business
              Class passengers should report to Emirates check-in desks not
              later than 1 hour prior to departure. Boarding for your flight
              begins at least 35 minutes before your scheduled departure time.
              Gates close 15 minutes prior to departure.{" "}
            </p>
            <p className="p4">
              <b>
                Please check with departure airport for restrictions on the
                carriage of liquids, aerosols and gels in hand baggage.
              </b>
            </p>
          </div>
          ...
          <div className="container details">
            <h6>
              Below are the details of your electronic ticket. Note: All timings
              are local.{" "}
            </h6>
              ...
              {passengerDetails.map((passenger, index) => (
                <div key={index}>
                  <table className="my-4 table table-striped table-bordered table-hover table-responsive border border-dark ">
                    ...
                    <tr>
                      <td scope="col">E-TICKET NUMBER</td>
            ...
            <div className="travelinfo container-fluid ">
              ...
              <table className="table table-striped table-bordered table-hover table-responsive border border-dark ">
                ...
                <tr>
                  <td>
                    {myflight.flightNumber} <br /> CONFIRMED{" "}
                  </td>
            ...
            <div className="fareinfo container">
              ...
              <p className="checkininfo mx-5 my-4">
                {" "}
                *AT CHECK-IN YOU MAY NEED TO PRESENT THE CREDIT CARD USED FOR
        ...
        <footer>
          <p className="foot">
            {" "}
            &copy; 2024 {myflight.airline}. All rights reserved.
          </p>
        </footer>
      </div>
    </div>
